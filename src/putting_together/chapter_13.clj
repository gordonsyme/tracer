...
(defn go
  ...
  (let [checked (pattern/with-transform
        ...
        table-material (-> (material/material)
        ...
        world (-> (world/world)
                  ...
                  (world/add-object cyl1)
                  (world/add-object cyl2)
                  (world/add-object cyl3)
                  (world/add-object cyl4)
                  (world/add-object cyl5))
